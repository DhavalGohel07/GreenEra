<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="GreenEra.AdminLogin" %>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary">Sign in Your Account</h3>
                            </a>
                        </div>
                       <div class="form-floating mb-3">
                            <asp:TextBox class="form-control" ID="adminemail" MaxLength="50" PlaceHolder="Username" runat="server" TextMode="Email" required="required"/>
                            <label for="floatingInput">Email address</label>
                        </div>
                        <div class="form-floating mb-4">
                         <asp:TextBox class="form-control" ID="adminpass" MaxLength="20" PlaceHolder="Password" runat="server" TextMode="Password" required="required"/>
                            <label for="floatingPassword">Password</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <a href="">Forgot Password..?</a>
                        </div>
                        <asp:Button class="btn btn-primary py-3 w-100 mb-4" Text="Sign Up" runat="server" OnClick="admin_login" />
                        <%--<button type="submit" class="btn btn-primary py-3 w-100 mb-4">Sign In</button>--%>
                        <p class="text-center mb-0">Don't have an Account? <a href="AdminReg.aspx">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>

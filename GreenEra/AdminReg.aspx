<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminReg.aspx.cs" Inherits="GreenEra.AdminReg" %>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <asp:TextBox ID="adminuser" class="form-control"  MaxLength="50" PlaceHolder="Username" runat="server" required="required"/>

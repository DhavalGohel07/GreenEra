<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="GreenEra.Order" %>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="Cart.aspx" class="nav-item nav-link"><i class="fa fa-shopping-cart" style="font-size: 27px"></i></a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-5">Your Order Placed Succesfully</h1>
                <img src="img/order.gif" alt="Computer man" style="width:500px;height:350px;"><br /><br />
            </div>
        </div>
    </div>
    <center>
